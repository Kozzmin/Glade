...
<ul>
	<li>
		<p> 		
      Participă la bătălii colosale de război de asediu PvP la nivel de server, apărându-ți <a href="">castelul</a> sau <a href="">fortareata</a> cu orice pret.</p>
	</li>
</ul>
<ul>
	<li>
		<p>
      Întâlniți o mare varietate de <a href="">șefii raidurilor</a> 
      în zone frumos proiectate în timp ce explorați acest vast teritoriu.</p>
	</li>
</ul>
<ul>
	<li>
		<p>
			Stăpânește sistemul avansat<a href=""> de luptă</a> și valorifică puterea deciziilor tactice în timp real în timpul luptei</p>
	</li>
</ul>
<ul>
	<li>
		<p>
			Formați un <a href="">clan</a> uniți-vă puterile pentru a învinge șefii mondiali epici, pentru a atinge obiective comune și pentru a avea propria  <a href=""> sală a clanului</a>.</p>
	</li>
</ul>
<ul>
	<li>
		<p>
			Îmbunătățește-ți jocul sau mărește-ți progresul cu articole disponibile <em><a href="">  Magazin&trade;</a></em> sau <em><a href="">  Galerie&trade;</a></em>.</p>
	</li>
</ul>
<ul>
	<li>
		<p>
			Creșteți animalele de companie pentru a fi tovarăși puternici și pentru a călători cu stil cu   <a href="">cai</a>.</p>
	</li>
</ul>
<p>
	<br />
