    ...
    <div class="glade-col l3 m6 glade-margin-bottom">
      <div class="glade-card">
        ...
        <div class="glade-container">
          ...
          <p><button class="glade-button glade-light-grey glade-block"><i class="fa fa-envelope"></i><a href="https://www.facebook.com/kozzmin.gani">Contact</a></button></p>
        </div>
      </div>
    </div>
    <div class="glade-col l3 m6 glade-margin-bottom">
      <div class="glade-card">
        ...
        <div class="glade-container">
          ...
          <p>Phasellus eget enim eu lectus faucibus vestibulum. Suspendisse sodales pellentesque elementum.</p>
          <p><button class="glade-button glade-light-grey glade-block"><i class="fa fa-envelope"></i><a href="https://www.facebook.com/mirela.patrascu.39">Contact</a></button></p>
        </div>
      </div>
    </div>
    <div class="glade-col l3 m6 glade-margin-bottom">
      <div class="glade-card">
        ...
        <div class="glade-container">
          ...
          <p>Phasellus eget enim eu lectus faucibus vestibulum. Suspendisse sodales pellentesque elementum.</p>
          <p><button class="glade-button glade-light-grey glade-block"><i class="fa fa-envelope"></i><a href="https://www.facebook.com/cimpoca.david">Contact</a></button></p>
        </div>
      </div>
    </div>
    <div class="glade-col l3 m6 glade-margin-bottom">
      <div class="glade-card">
        ...
        <div class="glade-container">
          ...
          <p>Phasellus eget enim eu lectus faucibus vestibulum. Suspendisse sodales pellentesque elementum.</p>
          <p><button class="glade-button glade-light-grey glade-block"><i class="fa fa-envelope"></i><a href="https://www.facebook.com/alexandru.caraulan">Contact</a></button></p>
        </div>
      </div>
    </div>
  </div>
