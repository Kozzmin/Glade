...
<nav id="navbar">
  ...
  <div id="navOverlay" class="overlay" >
    ...
    <a href="javascript:void(0)" class="closebtn" onclick="closeNav()"><img src="./resurse/photos/stuff/buttonX.png"  class="buttonX" alt=""></a>

    <div class="overlay-content"> <!--display flex-->

      <div class="overlay-contentDiv"> <!--de facut bara cum trebuie-->
