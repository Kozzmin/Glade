                    ...
                    <div class="secondary-nav">
                        ...
                        <ul class="menu-list">
                           <ul class="menu-list">
                             ...
                             <li><a href="/en/game/path-to-awakening/"><span class="link-text">Path to Awakening</span></a></li>
...
<p>
	<em>GLADE</em><em>&reg;</em><em>  </em> was revitalized with a variety of changes introduced with the launch of&nbsp;<em>Goddess of Destruction</em><em>&trade; </em>back in 2012, including the&nbsp;introduction of the <em>Truly Free&trade; </em>business model. &nbsp;</p>
<p>
	<em>Truly Free</em> breaks the shackles of limited gameplay and invites you to enjoy the full game world as it was meant to be experienced. <em>GLADE  : Goddess of Destruction</em> will provide you with all the tools you need to propel yourself to the heights of power and beyond. Follow the <a href="http://www.GLADE2.com/en/game/path-to-awakening/">Path to Awakening&trade;</a> from the starting zone for new characters and experience rapid progression through three class transfers on your way toward your destiny. At level 85, Awaken to one of the 37 classes with unique skills to advance your game experience and take on new challenges.&nbsp;&nbsp;<br />
	<br />
...
<ul>
	<li>
		<p>
			Choose your path by creating unique characters from seven different races: <a href="/en/game/races/human.php">Human</a>, <a href="/en/game/races/elf.php">Elf</a>, <a href="/en/game/races/dark-elf.php">Dark Elf</a>, <a href="/en/game/races/orc.php">Orc</a>, <a href="/en/game/races/dwarf.php">Dwarf</a>,&nbsp;<a href="/en/game/races/kamael.php">Kamael</a>, and Ertheia.</p>
	</li>
</ul>
<ul>
	<li>
...
<ul>
	<li>
		<p>
			Encounter a wide variety of <a href="/en/game/patch-notes/goddess-of-destruction/bosses/">raid bosses</a> in beautifully designed zones as you explore this vast land.</p>
	</li>
</ul>
<ul>
	<li>
		<p>
			Master the advanced <a href="/en/game/getting-started/how-to-play/general-gameplay.php">combat</a> system and harness the power of real-time tactical decisions while fighting.</p>
	</li>
</ul>
<ul>
	<li>
		<p>
			Form a <a href="/en/game/the-library/clans/index.php">clan</a> and unite your powers to defeat epic world bosses, achieve common goals, and have your own <a href="/en/game/the-library/clans/clan-halls.php">Clan Hall</a>.</p>
	</li>
</ul>
<ul>
	<li>
		<p>
			Enhance your game or increase your progression with items available in the <em><a href="/en/marketplace/ -store/">  Store&trade;</a></em> or <em><a href="http://store.GLADE2.com/">  Galleria&tradetrade;</a></em>.</p>
	</li>
</ul>
<ul>
	<li>
		<p>
			Raise pets to be powerful companions and to travel in style with a <a href="/en/game/patch-notes/goddess-of-destruction/classes-and-skills/awakening-mounts.php">mount</a>.</p>
	</li>
</ul>
<p>
	<br />
	Explore more details about GLADE  &nbsp;<a href="http://truly-free.GLADE.com/about">here</a>.</p>
